...
public class AddSpaServicesFrame extends javax.swing.JFrame {

    public AddSpaServicesFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 250, -1, -1));

        jLabel2.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Price($):");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 310, 134, -1));

        tfServiceName.setFont(new java.awt.Font("Montserrat", 1, 15)); // NOI18N
        jPanel1.add(tfServiceName, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 250, 210, 30));

        tfPrice.setFont(new java.awt.Font("Montserrat", 1, 15)); // NOI18N
        jPanel1.add(tfPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 310, 210, 30));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 370, 210, -1));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 20, -1, -1));

        jLabel4.setFont(new java.awt.Font("Montserrat", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Add Spa Services");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if ("".equals(tfServiceName.getText())) {
                ...
                // Update table name to 'spa_services'
                String query = "INSERT INTO spa_services (name, price) VALUES (?, ?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSpaServicesFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSpaServicesFrame().setVisible(true);
            }
        });
    }
